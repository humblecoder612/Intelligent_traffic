...
def read_image_and_lable(gt_path, hw, hue=.1, sat=1.5, val=1.5, is_training=True):
...
def plot_img(img, picked_boxes, color_table, classes, is_gt=False):
    """
